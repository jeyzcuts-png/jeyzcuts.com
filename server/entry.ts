...
// <api-imports>
import admin_seed_post_0 from "./api/admin/seed/POST";
import appointments_get_1 from "./api/appointments/GET";
import appointments_post_2 from "./api/appointments/POST";
import appointments_id_put_3 from "./api/appointments/[id]/PUT";
...
import gallery_get_8 from "./api/gallery/GET";
import gallery_post_9 from "./api/gallery/POST";
import gallery_id_delete_10 from "./api/gallery/[id]/DELETE";
import health_get_11 from "./api/health/GET";
import products_get_12 from "./api/products/GET";
import products_post_13 from "./api/products/POST";
import products_id_delete_14 from "./api/products/[id]/DELETE";
import products_id_put_15 from "./api/products/[id]/PUT";
import reviews_get_16 from "./api/reviews/GET";
import reviews_post_17 from "./api/reviews/POST";
import reviews_id_delete_18 from "./api/reviews/[id]/DELETE";
import reviews_id_put_19 from "./api/reviews/[id]/PUT";
import services_get_20 from "./api/services/GET";
import services_post_21 from "./api/services/POST";
import services_id_delete_22 from "./api/services/[id]/DELETE";
import services_id_put_23 from "./api/services/[id]/PUT";
// </api-imports>
...
// <api-registrations>
app.post("/api/admin/seed", admin_seed_post_0);
app.get("/api/appointments", appointments_get_1);
app.post("/api/appointments", appointments_post_2);
app.put("/api/appointments/:id", appointments_id_put_3);
...
app.get("/api/gallery", gallery_get_8);
app.post("/api/gallery", gallery_post_9);
app.delete("/api/gallery/:id", gallery_id_delete_10);
app.get("/api/health", health_get_11);
app.get("/api/products", products_get_12);
app.post("/api/products", products_post_13);
app.delete("/api/products/:id", products_id_delete_14);
app.put("/api/products/:id", products_id_put_15);
app.get("/api/reviews", reviews_get_16);
app.post("/api/reviews", reviews_post_17);
app.delete("/api/reviews/:id", reviews_id_delete_18);
app.put("/api/reviews/:id", reviews_id_put_19);
app.get("/api/services", services_get_20);
app.post("/api/services", services_post_21);
app.delete("/api/services/:id", services_id_delete_22);
app.put("/api/services/:id", services_id_put_23);
// </api-registrations>
